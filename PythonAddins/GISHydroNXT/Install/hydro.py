...
def statsgonlcdlookupgood(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,39],[22,54],[23,61],[24,77],
                                             [31,77],[41,30],[42,30],[43,30],[52,30],
                                             [71,39],[81,39],[82,67],[90,100],
                                             [95,100]]),"DATA")
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,61],[22,70],[23,75],[24,85],
                                             [31,86],[41,55],[42,55],[43,55],[52,48],
                                             [71,61],[81,61],[82,78],[90,100],
                                             [95,100]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,74],[22,80],[23,83],[24,90],
                                             [31,91],[41,70],[42,70],[43,70],[52,65],
                                             [71,74],[81,74],[82,85],[90,100],
                                             [95,100]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,80],[22,85],[23,87],[24,92],
...
def statsgonlcdlookuppoor(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,68],[22,76],[23,79],[24,88],
    ...
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,79],[22,84],[23,86],[24,91],
                                             ...
                                             [95,100]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,86],[22,89],[23,91],[24,94],
                                             [31,91],[41,77],[42,77],[43,77],[52,77],
                                             [71,86],[81,86],[82,86],[90,100],
                                             [95,100]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,89],[22,91],[23,92],[24,95],
...
def statsgoandlookupfair(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,68],[11,61],[12,68],[13,81],[14,91],
                                             ...
                                             [242,59]]),"DATA")
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,80],[11,76],[12,80],[13,88],[14,94],
                                             ...
                                             [242,74]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,86],[11,84],[12,86],[13,91],[14,95],
                                             ...
                                             [242,82]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,89],[11,88],[12,89],[13,93],[14,96],
...
def statsgoandlookupgood(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,61],[11,54],[12,61],[13,77],[14,89],
                                             ...
                                             [242,59]]),"DATA")
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,75],[11,70],[12,75],[13,85],[14,92],
                                             ...
                                             [242,74]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,83],[11,80],[12,83],[13,90],[14,94],
                                             ...
                                             [242,82]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,87],[11,85],[12,87],[13,92],[14,95],
...
def statsgoandlookuppoor(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,79],[11,76],[12,79],[13,88],[14,94],
    ...
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,86],[11,84],[12,86],[13,91],[14,95],
                                             ...
                                             [242,74]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,91],[11,89],[12,91],[13,94],[14,96],
                                             ...
                                             [242,82]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[10,92],[11,91],[12,92],[13,95],[14,97],
...
def statsgomrlclookupgood(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,54],[22,77],[23,89],[24,89],
                                             [31,77],[32,77],[33,77],[41,30],[42,30],
                                             [43,30],[81,39],[82,67],[85,39],[90,100],
                                             [91,100],[92,100],[95,100]]),"DATA")
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,70],[22,85],[23,92],[24,92],
                                             [31,86],[32,86],[33,86],[41,55],[42,55],
                                             [43,55],[81,61],[82,78],[85,61],[90,100],
                                             [91,100],[92,100],[95,100]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,80],[22,90],[23,94],[24,94],
                                             [31,91],[32,91],[33,91],[41,70],[42,70],
                                             [43,70],[81,74],[82,85],[85,74],[90,100],
                                             [91,100],[92,100],[95,100]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,85],[22,92],[23,95],[24,95],
...
def statsgomrlclookuppoor(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,76],[22,88],[23,89],[24,94],
                                             [31,77],[32,77],[33,77],[41,45],[42,45],
                                             [43,45],[81,68],[82,72],[85,68],[90,100],
                                             [91,100],[92,100],[95,100]]),"DATA")
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,84],[22,91],[23,92],[24,95],
                                             [31,86],[32,86],[33,86],[41,66],[42,66],
                                             [43,66],[81,79],[82,81],[85,79],[90,100],
                                             [91,100],[92,100],[95,100]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,89],[22,94],[23,94],[24,96],
                                             [31,91],[32,91],[33,91],[41,77],[42,77],
                                             [43,77],[81,86],[82,88],[85,86],[90,100],
                                             [91,100],[92,100],[95,100]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,100],[21,91],[22,95],[23,95],[24,97],
...
def statsgousgslookupfair(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,68],[12,91],[13,81],[14,98],[15,91],
    ...
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,80],[12,94],[13,88],[14,98],[15,94],
    ...
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,86],[12,95],[13,91],[14,98],[15,95],
    ...
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,89],[12,96],[13,93],[14,98],[15,96],
...
def statsgousgslookupgood(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,61],[12,89],[13,81],[14,98],[15,89],
                                             ...
                                             [75,77],[76,77],[77,77]]),"DATA")
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,75],[12,92],[13,88],[14,98],[15,92],
                                             ...
                                             [75,86],[76,86],[77,86]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,83],[12,94],[13,91],[14,98],[15,94],
                                             ...
                                             [75,91],[76,91],[77,91]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,87],[12,95],[13,93],[14,98],[15,95],
...
def statsgousgslookuppoor(inLU,inSoil,opath):
    ...
    # read landuse data
    lusG_a = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,79],[12,94],[13,90],[14,98],[15,94],
                                             ...
                                             [75,77],[76,77],[77,77]]),"DATA")
    lusG_b = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,86],[12,95],[13,93],[14,98],[15,95],
                                             ...
                                             [75,86],[76,86],[77,86]]),"DATA")
    lusG_c = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,91],[12,96],[13,95],[14,98],[15,96],
                                             ...
                                             [75,91],[76,91],[77,91]]),"DATA")
    lusG_d = arcpy.sa.Reclassify(inLU,"Value",
                                 arcpy.sa.RemapValue([[11,92],[12,97],[13,95],[14,98],[15,97],
